        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-10">
          ...
          <div className="flex flex-col gap-6 md:gap-5 items-center md:items-start text-center md:text-left">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-3">
              ...
              <div>
                <p className="text-white/90 text-lg md:text-sm font-body font-semibold md:font-normal">2 Impasse de la Sablière</p>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-center gap-3">
              ...
              <div>
                <a href="tel:+596696028400" className="text-white/90 text-lg md:text-sm font-semibold md:font-normal hover:text-yellow-300 transition-colors">
                  +596 696 02 84 00
                </a>
            ...
            <div className="flex items-center text-yellow-400 gap-6 md:gap-4 mt-2">
              ...
              <a href="https://wa.me/+596696028400" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="hover:opacity-70">
          ...
          <div className="rounded overflow-hidden h-48 md:h-full min-h-36 relative" style={{ filter: 'brightness(0.6) sepia(0.3)' }}>
            <div className="w-full h-full bg-gray-700 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-white/60 text-xs">2 Impasse de la Sablière</p>
